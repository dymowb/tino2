...
export class CreateServiceCategories1780800000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "quote_requests" ADD COLUMN IF NOT EXISTS "category" varchar`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_quote_requests_category" ON "quote_requests" ("category")`);
