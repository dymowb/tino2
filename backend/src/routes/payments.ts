...
router.get('/:id', idParamValidation, handleValidationErrors, PaymentController.getPaymentById);

// POST /api/payments/setup-intent - Create SetupIntent to save card (no charge)
router.post('/setup-intent', rateLimiters.general, PaymentController.createSetupIntent);
