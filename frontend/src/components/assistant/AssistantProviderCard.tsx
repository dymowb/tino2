  ...
  return (
    ...
    >
        ...
        <Box sx={{ mb: 2 }}>
          <Box sx={{ display: "flex", flexWrap: "wrap", gap: 0.5 }}>
            ...
            {provider.services.length > 3 && (
              <Chip
                label={t("providers:card.more_services", {
                  count: provider.services.length - 3,
                })}
                size="small"
                variant="outlined"
              />
      ...
      >
        ...
        <Tooltip
          title={
            selectionDisabled && !isSelected ? t("actions.maxSelected") : ""
          }
        >
          <span>
            <Chip
              ...
              onClick={
                selectionDisabled && !isSelected ? undefined : onToggleSelect
              }
              ...
              sx={{
                ...
                cursor:
                  selectionDisabled && !isSelected ? "not-allowed" : "pointer",
              }}
            />
          </span>
        </Tooltip>
